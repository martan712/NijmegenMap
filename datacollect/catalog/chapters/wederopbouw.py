...
from ...graph import Chapter, Img, Map, Narr, Segment, Story, Thread
    ...
    threads=(
        Thread("wed_opbouw", "Wederopbouw", 1, (
            ...
            Segment("wed_2", 2, "Een nieuw centrum",
                    map=Map(base=1957, focus=("centrum",)), blocks=(
                        Narr("In de jaren '50 verrijst een modern, ruimer opgezet stadshart op de oude fundamenten."),)),
            Segment("wed_3", 3, "De stad hersteld",
                    map=Map(base=1967, focus=("centrum",)), blocks=(
                        Narr("Tegen het eind van de jaren '60 is de wederopbouw grotendeels voltooid."),)),
        )),
