    ...
    threads=(
        Thread("pre", "Prehistorie", 1, (
            Segment("pre_1", 1, "Grafheuvels en urnenvelden",
                    map=Map(base=1557, focus=("nijmegen_oost",)),
                    blocks=(
            ...
            Segment("pre_2", 2, "De eerste Bataven",
                    map=Map(base=1557, focus=("waterstraat",)),
                    blocks=(
        ...
        Thread("rom", "Romeins Nijmegen", 2, (
            Segment("rom_1", 3, "De rand van het rijk",
                    map=Map(base=1557, overlay="limes", focus=("hunerberg",)),
                    blocks=(
            ...
            Segment("rom_3", 5, "Commandopost op het Kops Plateau",
                    map=Map(base=1557, overlay="limes", focus=("kops_plateau",)),
                    blocks=(
            ...
            Segment("rom_4", 6, "Oppidum Batavorum",
                    map=Map(base=1557, overlay="limes", focus=("valkhof",)),
                    blocks=(
